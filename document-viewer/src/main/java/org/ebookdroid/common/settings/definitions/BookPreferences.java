...
import static tex.pdfsync.viewer.R.string.pref_align_by_width;
import static tex.pdfsync.viewer.R.string.pref_animation_type_none;
import static tex.pdfsync.viewer.R.string.pref_autolevels_defvalue;
import static tex.pdfsync.viewer.R.string.pref_book_align_id;
import static tex.pdfsync.viewer.R.string.pref_book_animation_type_id;
import static tex.pdfsync.viewer.R.string.pref_book_autolevels_id;
import static tex.pdfsync.viewer.R.string.pref_book_contrast_id;
import static tex.pdfsync.viewer.R.string.pref_book_gamma_id;
import static tex.pdfsync.viewer.R.string.pref_book_croppages_id;
import static tex.pdfsync.viewer.R.string.pref_book_exposure_id;
import static tex.pdfsync.viewer.R.string.pref_book_firstpageoffset_defvalue;
import static tex.pdfsync.viewer.R.string.pref_book_firstpageoffset_id;
import static tex.pdfsync.viewer.R.string.pref_book_firstpageoffset_maxvalue;
import static tex.pdfsync.viewer.R.string.pref_book_firstpageoffset_minvalue;
import static tex.pdfsync.viewer.R.string.pref_book_id;
import static tex.pdfsync.viewer.R.string.pref_book_nightmode_id;
import static tex.pdfsync.viewer.R.string.pref_book_posimages_in_nightmode_id;
import static tex.pdfsync.viewer.R.string.pref_book_rotation_id;
import static tex.pdfsync.viewer.R.string.pref_book_rtl_id;
import static tex.pdfsync.viewer.R.string.pref_book_splitpages_id;
import static tex.pdfsync.viewer.R.string.pref_book_splitpages_rtl_id;
import static tex.pdfsync.viewer.R.string.pref_book_viewmode_id;
import static tex.pdfsync.viewer.R.string.pref_contrast_defvalue;
import static tex.pdfsync.viewer.R.string.pref_contrast_maxvalue;
import static tex.pdfsync.viewer.R.string.pref_contrast_minvalue;
import static tex.pdfsync.viewer.R.string.pref_gamma_defvalue;
import static tex.pdfsync.viewer.R.string.pref_gamma_maxvalue;
import static tex.pdfsync.viewer.R.string.pref_gamma_minvalue;
import static tex.pdfsync.viewer.R.string.pref_croppages_defvalue;
import static tex.pdfsync.viewer.R.string.pref_exposure_defvalue;
import static tex.pdfsync.viewer.R.string.pref_exposure_maxvalue;
import static tex.pdfsync.viewer.R.string.pref_exposure_minvalue;
import static tex.pdfsync.viewer.R.string.pref_nightmode_defvalue;
import static tex.pdfsync.viewer.R.string.pref_posimages_in_nightmode_defvalue;
import static tex.pdfsync.viewer.R.string.pref_rotation_unspecified;
import static tex.pdfsync.viewer.R.string.pref_rtl_defvalue;
import static tex.pdfsync.viewer.R.string.pref_splitpages_defvalue;
import static tex.pdfsync.viewer.R.string.pref_splitpages_rtl_defvalue;
import static tex.pdfsync.viewer.R.string.pref_tint_color_defvalue;
import static tex.pdfsync.viewer.R.string.pref_book_tint_color_id;
import static tex.pdfsync.viewer.R.string.pref_tint_defvalue;
import static tex.pdfsync.viewer.R.string.pref_book_tint_id;
import static tex.pdfsync.viewer.R.string.pref_viewmode_vertical_scroll;
