...
import static tex.pdfsync.viewer.R.string.pref_autoscanremovable_defvalue;
import static tex.pdfsync.viewer.R.string.pref_autoscanremovable_id;
import static tex.pdfsync.viewer.R.string.pref_brautoscandir_defvalue;
import static tex.pdfsync.viewer.R.string.pref_brautoscandir_id;
import static tex.pdfsync.viewer.R.string.pref_brfiletypes;
import static tex.pdfsync.viewer.R.string.pref_brsearchbookquery_id;
import static tex.pdfsync.viewer.R.string.pref_cachelocation_defvalue;
import static tex.pdfsync.viewer.R.string.pref_cachelocation_id;
import static tex.pdfsync.viewer.R.string.pref_shownotifications_defvalue;
import static tex.pdfsync.viewer.R.string.pref_shownotifications_id;
import static tex.pdfsync.viewer.R.string.pref_showremovable_defvalue;
import static tex.pdfsync.viewer.R.string.pref_showremovable_id;
import static tex.pdfsync.viewer.R.string.pref_showscanning_defvalue;
import static tex.pdfsync.viewer.R.string.pref_showscanning_id;
import static tex.pdfsync.viewer.R.string.pref_usebookcase_defvalue;
import static tex.pdfsync.viewer.R.string.pref_usebookcase_id;
